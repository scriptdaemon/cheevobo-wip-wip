...
class SteamBot {
  ...
  **/
  ...
  /**
   * Add Steam ID to tracking list.
   *
   * @private
   * @param {string} name - Tracking list name
   * @param {string} steamId - Steam ID
   * @param {Function} cb - Continuation function after saving tracking list
   * @returns {void}
  **/
  ...
  /**
   * Remove Steam ID from tracking list.
   *
   * @private
   * @param {string} name - Tracking list name
   * @param {string} steamId - Steam ID
